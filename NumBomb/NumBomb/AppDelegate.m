...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    [WXApi registerApp:@"wx6c625985c6d9c07b"];
    return YES;
}
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.vajaspine.NumBomb" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"NumBomb" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"NumBomb.sqlite"];
    NSError *error = nil;
...
- (void)sendByWeixin {
    if ([WXApi isWXAppInstalled] && [WXApi isWXAppSupportApi]) {
        ...
        message.title = @"快本同款猜数字游戏，AUV猴系列APP，小伙伴聚餐情侣约会玩什么不再愁";
        [message setThumbImage:[UIImage imageNamed:@"Icon-60@2x.png"]];
        
        WXWebpageObject *ext = [WXWebpageObject object];
        ext.webpageUrl = @"http://itunes.apple.com/app/id982954370?mt=8";
